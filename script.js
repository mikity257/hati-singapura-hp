...
const translations = {
  ja: {
    ...
    flow_c1_title:  "カウンセリング＆測定",
    flow_c1_desc:   "産後の体の状態をヒアリング。施術前後の変化を記録するためサイズを測定します。",
    ...
    flow_d2_note:   "到着前にさらしを外し、シャワーと授乳（または搾乳）をお済ませください。→ 全身オイルマッサージ＋腹部バインディング",
    flow_last_label:"■ 最終日",
    flow_last_note: "全身オイルマッサージのみ → サイズ測定・ビフォーアフター確認",
